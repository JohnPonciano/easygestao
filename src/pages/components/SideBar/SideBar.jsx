...
//         <a href='/' className="flex items-center justify-center p-4 text-red-400"
//          >
...
//       {!isMobile && (
//         <a href='/' className="flex items-center justify-center p-4 text-red-400" onClick={closeMenu}>
//           <LogOut size={20} className="mr-2" />
//           <span>Sair</span>
//         </a>
//       )}
