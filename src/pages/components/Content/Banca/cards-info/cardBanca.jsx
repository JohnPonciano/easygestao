...
export const CardBanca = () => {
    // Exemplo de dados para as grades (substitua com seus dados reais)
    const data = [
        { nome: 'Banca 1', unidade: 'R$10,00', stake: '1%', bancaInicial: 'R$100,00', roi: '-', profit: '-' },
        { nome: 'Banca 2', unidade: 'R$15,00', stake: '2%', bancaInicial: 'R$150,00', roi: '+70.00%', profit: 'R$350,00' },
        { nome: 'Banca 3', unidade: 'R$20,00', stake: '3%', bancaInicial: 'R$200,00', roi: '+70.00%', profit: 'R$350,00' },
    ];

    // Função para renderizar os botões de Entradas, Positivo e Negativo
    const renderEntradasButtons = () => (
        <div className="flex flex-col space-y-2.5 items-start justify-start">
            ...
            <div className="inline-flex space-x-6 items-center justify-start w-full">
    ...
    return (
        <div className="flex mt-20 p-8 flex-col flex-grow items-start justify-start w-full max-w-screen-xl mx-auto">
            <div className="grid grid-cols-3 gap-4">
                {data.map((cardData, index) => (
                    <div key={index} className="flex-col bg-gray-800 border rounded-2xl border-gray-600 p-4">
                        ...
                        <button className="flex items-center justify-end w-full p-2">
