...
export const CardBanca = () => {
  ...
  return (
    <div style={{ maxHeight: "500px", overflowY: "auto", scrollbarWidth: "thin", msOverflowStyle: "none" }} className="flex mt-10 p-8 flex-col flex-grow items-start justify-start w-full max-w-screen-xl mx-auto overflow-y-auto">
      {showCards ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4">
          {data.map((cardData, index) => (
            <div key={index} className="flex-col bg-gray-800 border rounded-2xl border-gray-600 p-4 mb-4">
